<?php
/**
 * generate_allow.php — UNIFIED ALLOWLIST GENERATOR (EasyPrivacy)
 * Location: all-in-one/easyprivacy/allow/
 *
 * Fetches all EasyPrivacy allowlist sources (1 list)
 * and routes each parsed rule into the correct output file.
 *
 * SOURCES (1 list):
 *   easyprivacy_allowlist             — Network allow rules (exceptions for analytics/tracking)
 *
...
$WORK = $ROOT . '/build/compile/.work/easyprivacy/allow';
if (!is_dir($WORK)) mkdir($WORK, 0777, true);

$sourceFiles = [
    // Network allow rules (tracking/privacy exceptions)
    $SNAP . '/easyprivacy/easyprivacy_allowlist.txt',
];
...
echo "╔══════════════════════════════════════════════════════════════╗\n";
echo "║       UNIFIED ALLOWLIST GENERATOR — EasyPrivacy             ║\n";
echo "╚══════════════════════════════════════════════════════════════╝\n\n";
