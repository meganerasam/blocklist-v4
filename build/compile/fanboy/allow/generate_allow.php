<?php
/**
 * generate_allow.php — UNIFIED ALLOWLIST GENERATOR (Fanboy)
 * Location: all-in-one/fanboy/allow/
 *
 * Fetches all Fanboy annoyance & age-gate allowlist sources (3 lists)
 * and routes each parsed rule into the correct output file.
 *
 * SOURCES (3 lists):
 *   fanboy_annoyance_allowlist             — Network allow rules
 *   fanboy_agegate_allowlist               — Age-gate network allow rules
 *   fanboy_annoyance_allowlist_general_hide — CSS unhide rules
 *
...
$WORK = $ROOT . '/build/compile/.work/fanboy/allow';
if (!is_dir($WORK)) mkdir($WORK, 0777, true);

$sourceFiles = [
    // Network allow rules (annoyance exceptions)
    $SNAP . '/fanboy-addon/fanboy_annoyance_allowlist.txt',
    // Network allow rules (age-gate exceptions)
    $SNAP . '/fanboy-addon/fanboy_agegate_allowlist.txt',
    // CSS unhide rules (re-show elements hidden by generic.css)
    $SNAP . '/fanboy-addon/fanboy_annoyance_allowlist_general_hide.txt',
];
...
echo "╔══════════════════════════════════════════════════════════════╗\n";
echo "║   UNIFIED ALLOWLIST GENERATOR — Fanboy Annoyance + Age Gate ║\n";
echo "╚══════════════════════════════════════════════════════════════╝\n\n";
