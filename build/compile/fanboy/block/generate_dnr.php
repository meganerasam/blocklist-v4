...
$WORK = $ROOT . '/build/compile/.work/fanboy/block';
if (!is_dir($WORK)) mkdir($WORK, 0777, true);

$sourceFiles = [
    // Annoyance lists
    $SNAP . '/fanboy-addon/fanboy_annoyance_thirdparty.txt',
    $SNAP . '/fanboy-addon/fanboy_annoyance_specific_uBO.txt',
    $SNAP . '/fanboy-addon/fanboy_annoyance_specific_block.txt',
    $SNAP . '/fanboy-addon/fanboy_annoyance_general_block.txt',
    // Age Gate lists
    $SNAP . '/fanboy-addon/fanboy_agegate_thirdparty.txt',
    $SNAP . '/fanboy-addon/fanboy_agegate_specific_uBO.txt',
    $SNAP . '/fanboy-addon/fanboy_agegate_specific_block.txt',
    $SNAP . '/fanboy-addon/fanboy_agegate_general_block.txt',
];
